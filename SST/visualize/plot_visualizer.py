...
for name,LOG in zip(["CIFAR-100","CIFAR-10"],[C10_LOG,C100_LOG]):
    ...
    ax.plot(xs, [SSKD_WITHSS[0][0],SSKD_WITHSS[1][0]],"x--", markersize=10,label=r'${}$'.format("SSKD\ with\ \mathcal{L}_{ss}"), color="#DC143C", linewidth=2)
    "============================"
    ...
    ax.plot(xs, [SSKD_WITHOUTSS[0][0],SSKD_WITHOUTSS[1][0]],"x--",markersize=10, label=r'${}$'.format("SSKD\ without\ \mathcal{L}_{ss}"), color="#8A2BE2", linewidth=2)
    "============================="
    ...
    ax.plot(xs, [HSAKD_WITHSS[0][0],HSAKD_WITHSS[1][0]],"x--", markersize=10,label=r'${}$'.format("HSAKD\ with\ \mathcal{L}_{kl\_q}"), color="#2E8B57", linewidth=2)
    "============================"
    ...
    ax.plot(xs, [HSAKD_WITHOUTSS[0][0],HSAKD_WITHOUTSS[1][0]],"x--",markersize=10, label=r'${}$'.format("HSAKD\ without\ \mathcal{L}_{kl\_q}"), color="#000000", linewidth=2)
    "============================="
