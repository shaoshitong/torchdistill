...
def get_argparser():
    ...
    parser.add_argument('--config',default='configs/sample/cifar10/kd/resnet18_from_resnet50_spkd.yaml',help='yaml file path')
    # densenet100_from_densenet250-final_run.yaml resnet18_from_resnet50-final_run.yaml
    parser.add_argument('--device', default='cuda', help='device')
    parser.add_argument('--log', default='log/cifar10/kd/resnet18_from_resnet50_spkd.txt',help='log file path')
