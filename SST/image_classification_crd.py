...
# '/home/sst/product/torchdistill/configs/sample/ilsvrc2012/single_stage/fkd/fkd-resnet18_from_resnet34.yaml'
# /home/sst/product/torchdistill/configs/official/ilsvrc2012/yoshitomo-matsubara/rrpr2020/at-resnet18_from_resnet34.yaml

def get_argparser():
    parser = argparse.ArgumentParser(description='Knowledge distillation for image classification models')
    parser.add_argument('--config',default='/home/sst/product/torchdistill/configs/sample/ilsvrc2012/single_stage/fkd/fkd-resnet18_from_resnet34.yaml',help='yaml file path')
    # densenet100_from_densenet250-final_run.yaml resnet18_from_resnet50-final_run.yaml
    parser.add_argument('--device', default='cuda', help='device')
    parser.add_argument('--log', default='log/cifar10/kd/resnet18_from_resnet50_crdloss.txt',help='log file path')
