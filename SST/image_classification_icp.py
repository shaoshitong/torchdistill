...
os.chdir('D:/Product/torchdistill')
root = os.getcwd()
...
import SST.loss.ICPLoss
logger = def_logger.getChild(__name__)


def get_argparser():
    parser = argparse.ArgumentParser(description='Knowledge distillation for image classification models')
    parser.add_argument('--config', default='configs/sample/cifar10/kd/resnet18_from_resnet50_icp_stage2.yaml',
                        help='yaml file path')
    # densenet100_from_densenet250-final_run.yaml resnet18_from_resnet50-final_run.yaml
    parser.add_argument('--device', default='cuda', help='device')
    parser.add_argument('--log', default='log/cifar10/kd/icp/resnet18_from_resnet50_true_adnamic_0.0_0.0_1.0_0.0_0.0_1.0.txt', help='log file path')
